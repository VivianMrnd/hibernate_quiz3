...
public class PersonDetail implements Serializable {
	...
	private Map<String, barangay> barangays;

	public PersonDetail() {}

	public PersonDetail(int p_id, String lastname, String firstname, 
			String middlename, int age, Map<String, barangay> barangays) {
		this.p_id = p_id;
	...
	public Map<String, barangay> getBarangays() {
		return barangays;
	}

	public void setBarangays(Map<String, barangay> barangays) {
		this.barangays = barangays;
	}
